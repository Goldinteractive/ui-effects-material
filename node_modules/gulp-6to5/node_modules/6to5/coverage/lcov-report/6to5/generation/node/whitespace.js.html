...
&nbsp;
    SpreadProperty: <span class="fstat-no" title="function not covered" >function (node, parent) {</span>
<span class="cstat-no" title="statement not covered" >      return exports.before.nodes.Property(node, parent);</span>
    },
&nbsp;
