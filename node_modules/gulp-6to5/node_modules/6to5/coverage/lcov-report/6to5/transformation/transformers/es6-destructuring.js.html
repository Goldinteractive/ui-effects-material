...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/es6-destructuring.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/es6-destructuring.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.37% <small>(134 / 142)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">84.85% <small>(56 / 66)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">94.12% <small>(16 / 17)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">94.53% <small>(121 / 128)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/</a> &#187; es6-destructuring.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">14</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// TODO: Clean up
&nbsp;
var t = require("../../types");
  ...
  _.each(pattern.properties, function (prop, i) {
    if (t.isSpreadProperty(prop)) {
        ...
        _.each(pattern.properties, function (prop2, i2) {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (t.isSpreadProperty(prop2)) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
          var key = prop2.key;
